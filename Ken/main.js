...
function Unicorn(game) {
    ...
    this.animation = new Animation(ASSET_MANAGER.getAsset("./img/pika-walk.jpg"), 0, 0, 45, 45, 0.11, 3, true, true);
...
ASSET_MANAGER.queueDownload("./img/pika-walk.jpg");
ASSET_MANAGER.queueDownload("./img/pika-jump.jpg");
ASSET_MANAGER.queueDownload("./img/stage.gif");
...
ASSET_MANAGER.downloadAll(function () {
    ...
    var bg = new Background(gameEngine, ASSET_MANAGER.getAsset("./img/stage.gif"));
